...
\block {
	...
	\subsubsection{\mt{MainActivity osztály}{}}
...
\block {
	\subsubsection{LoggedInActivity \mt{osztály}{}}
...
\block {
	\subsubsection{Worker \mt{osztály}{}}
...
\begin{landscape}
	\begin{figure}
		...
		\caption{\mt{Szerkesztő osztályok diagrammja}{}}
	\end{figure}
\end{landscape}

\block {
	\subsubsection{BaseEditActivity \mt{osztály}{}}
...
\block {
	\subsubsection{LocalEditActivity \mt{osztály}{}}
...
\begin{landscape}
	\begin{figure}
		...
		\caption{\mt{Listázó activity osztályok diagrammja}{}}
	\end{figure}
\end{landscape}

\block {
	\subsubsection{PaginatedListActivity \mt{osztály}{}}
...
\block {
	\subsubsection{BaseListActivity \mt{osztály}{}}
...
\begin{landscape}
	\begin{figure}
		...
		\caption{\mt{Listázó fragment osztályok diagrammja}{}}
	\end{figure}
\end{landscape}

\block {
	\subsubsection{BaseListFragment \mt{osztály}{}}
...
\block {
	\subsubsection{LocalListFragment \mt{osztály}{}}
...
\block {
	\subsubsection{SelectableArrayAdapter \mt{osztály}{}}

	\p{\mt{%
			A \code{SelectableArrayAdapter} absztrakt osztály az \code{ArrayAdapter} o\-sz\-tály implementálását segíti kijelölhető listákra.
		}{}
	}
}
